...
const NFTData = [
  ...
  {
    id: "NFT-02",
    name: "WEB 3.0 Fashion",
    creator: "MetaTrends",
    price: 7.25,
    description:
      "We are all tired of the same and repetitive images. Metatrends is a completely different take on fashion. Created by the coolest Dopebroky Daniel, whose images reversed everything upside down not only in ours, but also in the meta-world.",
    image: assets.metatrends,
    bids: [
      {
        id: "BID-21",
        name: "Jessica Tan",
        price: 7.05,
        image: assets.person13,
        date: "July 12, 2022 at 12:10 PM",
      },
    ],
  },
  {
    ...
    price: 95.25,
    description:
      "10,000 Cubies walking towards the Metaverse. A NFT project ready to deliver top notch utility and rewards.",
    image: assets.cubex,
    bids: [
      {
        id: "BID-31",
